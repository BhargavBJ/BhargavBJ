...
- 📚 **[Automate literature reviews](https://github.com/BhargavBJ/Automating-Literature-Review)**  
  This project fetches papers via the Papers with Code API, extracts content from PDFs, and generates concise summaries to streamline academic research.

- 🐧⚙️ **[ArchDev OS](https://github.com/BhargavBJ/ArchDev-OS)**  
  ArchDev-OS is a custom-built Arch Linux environment designed specifically for developers.It comes preinstalled with essential tools like Python, C/C++, Git, and Docker, providing a ready-to-use, lightweight workspace.
...
- 🩻 **[Pneumonia Detection Using Chest X-Ray Images](https://github.com/BhargavBJ/Chest-X-Ray-Pneumonia-Detection)**
  Built a deep learning model using transfer learning to automatically classify pediatric chest X-ray images as Normal or Pneumonia, enabling efficient and accurate pneumonia detection.
